...
def homepage():
    ...
    bank=Button(text='3. Bank Balance',font=('Times',22,'bold'),fg='white',bg='navy',width=13,height=1)
    game=Button(text='4. Games            ',font=('Times',22,'bold'),fg='white',bg='navy',width=13,height=1,command=Game)
    calc=Button(text='5. Calculator      ',font=('Times',22,'bold'),fg='white',bg='navy',width=13,height=1)
